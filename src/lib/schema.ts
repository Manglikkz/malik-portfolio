  ...
  try {
    ...
    await sql`
      ...
      VALUES 
        ...
        ('sk-8', 'GitHub', 'TOOLS', 'Github', 'CI/CD workflows, pull requests, releases', true, 2),
        ...
        ('sk-12', 'Figma', 'TOOLS', 'Figma', 'Wireframing, UI/UX prototyping, layout design', true, 6),
    ...
    await sql`
      ...
      VALUES 
        ...
        ('soc-2', 'Instagram', '@malik.ibrahim', 'https://instagram.com', 'Instagram', true, 2),
        ('soc-3', 'WhatsApp', '+62 812-3456-7890', 'https://wa.me/6281234567890', 'MessageCircle', true, 3),
        ('soc-4', 'GitHub', 'github.com/malik-ibrahim', 'https://github.com', 'Github', true, 4)
      ON CONFLICT (id) DO NOTHING
    `;
